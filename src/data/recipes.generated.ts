...
const RECIPES: Readonly<{ [R in RecipeKey]: Readonly<KeyedRecipe<R>> }> = {
  Accumulator: new StandardRecipe({
    ...
    components: { CrystalSilicon: -4, IronIngot: -6, SuperMagneticRing: -6, Accumulator: 1 },
  ...
  AnnihilationConstraintSphere: new StandardRecipe({
    ...
    components: { ParticleContainer: -1, Processor: -1, AnnihilationConstraintSphere: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  AssemblingMachineMkI: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { CircuitBoard: -4, Gear: -8, IronIngot: -4, AssemblingMachineMkI: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  AssemblingMachineMkII: new StandardRecipe({
    ...
    components: { AssemblingMachineMkI: -1, Graphene: -8, Processor: -4, AssemblingMachineMkII: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  AssemblingMachineMkIII: new StandardRecipe({
    ...
    components: { AssemblingMachineMkII: -1, ParticleBroadband: -8, QuantumChip: -2, AssemblingMachineMkIII: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  CarbonNanotube: new StandardRecipe({
    ...
    name: "CarbonNanotube",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { Graphene: -3, TitaniumIngot: -1, CarbonNanotube: 2 },
    buildings: ["ChemicalPlant"],
  ...
  CarbonNanotubeGraphene: new StandardRecipe({
    ...
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { SpiniformStalagmiteCrystal: -2, CarbonNanotube: 2 },
    buildings: ["ChemicalPlant"],
    prerequisites: ["HighStrengthMaterial"],
  }),
  ...
  CasimirCrystal: new StandardRecipe({
    ...
    name: "CasimirCrystal",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { Graphene: -2, Hydrogen: -12, TitaniumCrystal: -1, CasimirCrystal: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  CasimirCrystalTitaniumCrystal: new StandardRecipe({
    ...
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { Graphene: -2, Hydrogen: -12, OpticalGratingCrystal: -6, CasimirCrystal: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["CasimirCrystal"],
  }),
  ...
  ChemicalPlant: new StandardRecipe({
    ...
    name: "ChemicalPlant",
    productionTime: new Time(5, TimeUnit.SECONDS),
    components: { CircuitBoard: -2, Glass: -8, Steel: -8, StoneBrick: -8, ChemicalPlant: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  CircuitBoard: new StandardRecipe({
    ...
    components: { CopperIngot: -1, IronIngot: -2, CircuitBoard: 2 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: [],
  }),
  ...
  ConveyorBeltMkI: new StandardRecipe({
    ...
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { Gear: -1, IronIngot: -2, ConveyorBeltMkI: 3 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  ConveyorBeltMkII: new StandardRecipe({
    ...
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { ConveyorBeltMkI: -3, ElectromagneticTurbine: -1, ConveyorBeltMkII: 3 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  ConveyorBeltMkIII: new StandardRecipe({
    ...
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { ConveyorBeltMkII: -3, Graphene: -1, SuperMagneticRing: -1, ConveyorBeltMkIII: 3 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  CopperIngot: new StandardRecipe({
    ...
    name: "CopperIngot",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { CopperOre: -1, CopperIngot: 1 },
    buildings: ["Smelter"],
  ...
  CopperOre: new StandardRecipe({
    ...
    name: "CopperOre",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { CopperVein: -1, CopperOre: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  CrystalSilicon: new StandardRecipe({
    ...
    name: "CrystalSilicon",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { HighPuritySilicon: -1, CrystalSilicon: 1 },
    buildings: ["Smelter"],
  ...
  Deuterium: new StandardRecipe({
    ...
    name: "Deuterium",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { Hydrogen: -1, Deuterium: 1 },
  ...
  DeuteronFuelRod: new StandardRecipe({
    ...
    components: { Deuterium: -10, SuperMagneticRing: -1, TitaniumAlloy: -1, DeuteronFuelRod: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  Diamond: new StandardRecipe({
    ...
    name: "Diamond",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { EnergeticGraphite: -1, Diamond: 1 },
    buildings: ["Smelter"],
    prerequisites: ["CrystalSmelting"],
  }),
  ...
  DiamondEnergeticGraphite: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { KimberliteOre: -1, Diamond: 1 },
    buildings: ["Smelter"],
    prerequisites: ["CrystalSmelting"],
  }),
  ...
  DysonSphereComponent: new StandardRecipe({
    ...
    components: { FrameMaterial: -3, Processor: -3, SolarSail: -3, DysonSphereComponent: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  ElectricMotor: new StandardRecipe({
    ...
    name: "ElectricMotor",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { Gear: -1, IronIngot: -2, MagneticCoil: -1, ElectricMotor: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  ElectromagneticMatrix: new StandardRecipe({
    ...
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -1, MagneticCoil: -1, ElectromagneticMatrix: 1 },
    buildings: ["MatrixLab"],
  ...
  ElectromagneticTurbine: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { ElectricMotor: -2, MagneticCoil: -2, ElectromagneticTurbine: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  EMRailEjector: new StandardRecipe({
    ...
    name: "EMRailEjector",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { Gear: -20, Processor: -5, Steel: -20, SuperMagneticRing: -10, EMRailEjector: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  EnergeticGraphite: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { Coal: -2, EnergeticGraphite: 1 },
    buildings: ["Smelter"],
  ...
  EnergyExchanger: new StandardRecipe({
    ...
    components: { ParticleContainer: -8, Processor: -40, Steel: -40, TitaniumAlloy: -40, EnergyExchanger: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  EnergyMatrix: new StandardRecipe({
    ...
    name: "EnergyMatrix",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { EnergeticGraphite: -2, Hydrogen: -2, EnergyMatrix: 1 },
    buildings: ["MatrixLab"],
  ...
  FireIce: new StandardRecipe({
    ...
    name: "FireIce",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { FireIceVein: -1, FireIce: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  Foundation: new StandardRecipe({
    ...
    name: "Foundation",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { Steel: -1, StoneBrick: -3, Foundation: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  FractalSilicon: new StandardRecipe({
    ...
    name: "FractalSilicon",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { FractalSiliconVein: -1, FractalSilicon: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  Fractionator: new StandardRecipe({
    ...
    name: "Fractionator",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { Glass: -4, Processor: -1, Steel: -8, StoneBrick: -4, Fractionator: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["DeuteriumFractionation"],
  }),
  ...
  FrameMaterial: new StandardRecipe({
    ...
    name: "FrameMaterial",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { CarbonNanotube: -4, HighPuritySilicon: -1, TitaniumAlloy: -1, FrameMaterial: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["HighStrengthLightweightStructure"],
  }),
  ...
  FullAccumulator: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { Accumulator: -1, FullAccumulator: 1 },
  ...
  Graphene: new StandardRecipe({
    ...
    name: "Graphene",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { EnergeticGraphite: -3, SulfuricAcid: -1, Graphene: 2 },
    buildings: ["ChemicalPlant"],
    prerequisites: ["AppliedSuperconductor"],
  }),
  ...
  GravitonLens: new StandardRecipe({
    ...
    name: "GravitonLens",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { Diamond: -4, StrangeMatter: -1, GravitonLens: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  GravityMatrix: new StandardRecipe({
    ...
    components: { GravitonLens: -1, QuantumChip: -1, GravityMatrix: 2 },
    buildings: ["MatrixLab"],
    prerequisites: ["SmeltingPurification"],
  }),
  ...
  HighPuritySilicon: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { SiliconOre: -2, HighPuritySilicon: 1 },
    buildings: ["Smelter"],
    prerequisites: ["SmeltingPurification"],
  }),
  ...
  HydrogenFuelRod: new StandardRecipe({
    ...
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { Hydrogen: -5, TitaniumIngot: -1, HydrogenFuelRod: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["EnergyStorage"],
  }),
  ...
  InformationMatrix: new StandardRecipe({
    ...
    components: { ParticleBroadband: -1, Processor: -2, InformationMatrix: 1 },
    buildings: ["MatrixLab"],
  ...
  IronIngot: new StandardRecipe({
    ...
    name: "IronIngot",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { IronOre: -1, IronIngot: 1 },
    buildings: ["Smelter"],
    prerequisites: ["AutomaticMetallurgy"],
  }),
  ...
  IronOre: new StandardRecipe({
    ...
    name: "IronOre",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { IronOreVein: -1, IronOre: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  KimberliteOre: new StandardRecipe({
    ...
    name: "KimberliteOre",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { KimberliteOreVein: -1, KimberliteOre: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  LogisticsDrone: new StandardRecipe({
    ...
    name: "LogisticsDrone",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { IronIngot: -5, Processor: -2, Thruster: -2, LogisticsDrone: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["PlanetaryLogisticsSystem"],
  }),
  ...
  LogisticsVessel: new StandardRecipe({
    ...
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { Processor: -10, ReinforcedThruster: -2, TitaniumAlloy: -10, LogisticsVessel: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["InterstellarLogisticsSystem"],
  }),
  ...
  MagneticCoil: new StandardRecipe({
    ...
    name: "MagneticCoil",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { CopperIngot: -1, Magnet: -2, MagneticCoil: 2 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: [],
  }),
  ...
  MatrixLab: new StandardRecipe({
    ...
    name: "MatrixLab",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -4, Glass: -4, IronIngot: -8, MagneticCoil: -4, MatrixLab: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["ElectromagneticMatrix"],
  }),
  ...
  MicrocrystallineComponent: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { CopperIngot: -1, HighPuritySilicon: -2, MicrocrystallineComponent: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  MiningMachine: new StandardRecipe({
    ...
    name: "MiningMachine",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -2, Gear: -2, IronIngot: -4, MagneticCoil: -2, MiningMachine: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  OilExtractor: new StandardRecipe({
    ...
    name: "OilExtractor",
    productionTime: new Time(8, TimeUnit.SECONDS),
    components: { CircuitBoard: -6, PlasmaExciter: -4, Steel: -12, StoneBrick: -12, OilExtractor: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["PlasmaExtractRefining"],
  }),
  ...
  OilRefinery: new StandardRecipe({
    ...
    name: "OilRefinery",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { CircuitBoard: -6, PlasmaExciter: -6, Steel: -10, StoneBrick: -10, OilRefinery: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["PlasmaExtractRefining"],
  }),
  ...
  OpticalGratingCrystal: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { OpticalGratingRock: -1, OpticalGratingCrystal: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  OrganicCrystal: new StandardRecipe({
    ...
    name: "OrganicCrystal",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { Plastic: -2, RefinedOil: -1, Water: -1, OrganicCrystal: 1 },
    buildings: ["ChemicalPlant"],
  ...
  ParticleBroadband: new StandardRecipe({
    ...
    productionTime: new Time(8, TimeUnit.SECONDS),
    components: { CarbonNanotube: -2, CrystalSilicon: -2, Plastic: -1, ParticleBroadband: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["ParticleControlTechnology"],
  }),
  ...
  ParticleContainer: new StandardRecipe({
    ...
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { CopperIngot: -2, ElectromagneticTurbine: -2, Graphene: -2, ParticleContainer: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  ParticleContainerElectromagneticTurbine: new StandardRecipe({
    ...
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { CopperIngot: -2, UnipolarMagnet: -10, ParticleContainer: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["MagneticParticleTrap"],
  }),
  ...
  PhotonCombiner: new StandardRecipe({
    ...
    name: "PhotonCombiner",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -1, Prism: -2, PhotonCombiner: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  PhotonCombinerPrism: new StandardRecipe({
    ...
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -1, OpticalGratingCrystal: -1, PhotonCombiner: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["PhotonFrequencyConversion"],
  }),
  ...
  PlaneFilter: new StandardRecipe({
    ...
    name: "PlaneFilter",
    productionTime: new Time(12, TimeUnit.SECONDS),
    components: { CasimirCrystal: -1, TitaniumGlass: -2, PlaneFilter: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  PlasmaExciter: new StandardRecipe({
    ...
    name: "PlasmaExciter",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { MagneticCoil: -4, Prism: -2, PlasmaExciter: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  Plastic: new StandardRecipe({
    ...
    name: "Plastic",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { EnergeticGraphite: -1, RefinedOil: -2, Plastic: 1 },
    buildings: ["ChemicalPlant"],
    prerequisites: ["BasicChemicalEngineering"],
  }),
  ...
  Processor: new StandardRecipe({
    ...
    name: "Processor",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -2, MicrocrystallineComponent: -2, Processor: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  QuantumChip: new StandardRecipe({
    ...
    name: "QuantumChip",
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { PlaneFilter: -2, Processor: -2, QuantumChip: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  ReinforcedThruster: new StandardRecipe({
    ...
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { ElectromagneticTurbine: -5, TitaniumAlloy: -5, ReinforcedThruster: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  SatelliteSubstation: new StandardRecipe({
    ...
    productionTime: new Time(5, TimeUnit.SECONDS),
    components: { FrameMaterial: -2, SuperMagneticRing: -10, WirelessPowerTower: -1, SatelliteSubstation: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  SiliconOre: new StandardRecipe({
    ...
    name: "SiliconOre",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { SiliconOreVein: -1, SiliconOre: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  SiliconOreMiningMachine: new StandardRecipe({
    ...
    productionTime: new Time(10, TimeUnit.SECONDS),
    components: { Stone: -10, SiliconOre: 1 },
    buildings: ["Smelter"],
    prerequisites: ["SmeltingPurification"],
  }),
  ...
  SmallCarrierRocket: new StandardRecipe({
    ...
    productionTime: new Time(6, TimeUnit.SECONDS),
    components: { DeuteronFuelRod: -2, DysonSphereComponent: -2, QuantumChip: -2, SmallCarrierRocket: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  Smelter: new StandardRecipe({
    ...
    name: "Smelter",
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { CircuitBoard: -4, IronIngot: -4, MagneticCoil: -2, StoneBrick: -2, Smelter: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["AutomaticMetallurgy"],
  }),
  ...
  SolarPanel: new StandardRecipe({
    ...
    name: "SolarPanel",
    productionTime: new Time(5, TimeUnit.SECONDS),
    components: { CircuitBoard: -4, CopperIngot: -6, HighPuritySilicon: -6, SolarPanel: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  SolarSail: new StandardRecipe({
    ...
    name: "SolarSail",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { Graphene: -1, PhotonCombiner: -1, SolarSail: 2 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["SolarSailOrbitSystem"],
  }),
  ...
  SorterMkI: new StandardRecipe({
    ...
    name: "SorterMkI",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { CircuitBoard: -1, IronIngot: -1, SorterMkI: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["BasicLogisticsSystem"],
  }),
  ...
  SorterMkII: new StandardRecipe({
    ...
    name: "SorterMkII",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { ElectricMotor: -1, SorterMkI: -2, SorterMkII: 2 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  SorterMkIII: new StandardRecipe({
    ...
    name: "SorterMkIII",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { ElectromagneticTurbine: -1, SorterMkII: -2, SorterMkIII: 2 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["HighEfficiencyLogisticsSystem"],
  }),
  ...
  SpaceWarper: new StandardRecipe({
    ...
    name: "SpaceWarper",
    productionTime: new Time(10, TimeUnit.SECONDS),
    components: { GravitonLens: -1, SpaceWarper: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["GravitationalWaveRefraction"],
  }),
  ...
  SpiniformStalagmiteCrystal: new StandardRecipe({
    ...
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { SpiniformStalagmiteCrystalVein: -1, SpiniformStalagmiteCrystal: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  Splitter: new StandardRecipe({
    ...
    name: "Splitter",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { CircuitBoard: -1, Gear: -2, IronIngot: -3, Splitter: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["ImprovedLogisticsSystem"],
  }),
  ...
  Stone: new StandardRecipe({
    ...
    name: "Stone",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { StoneOreVein: -1, Stone: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  StoneBrick: new StandardRecipe({
    ...
    name: "StoneBrick",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { Stone: -1, StoneBrick: 1 },
    buildings: ["Smelter"],
    prerequisites: [],
  }),
  ...
  StorageMkI: new StandardRecipe({
    ...
    name: "StorageMkI",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { IronIngot: -4, StoneBrick: -4, StorageMkI: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["BasicLogisticsSystem"],
  }),
  ...
  StorageMkII: new StandardRecipe({
    ...
    name: "StorageMkII",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { Steel: -8, StoneBrick: -8, StorageMkII: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["HighEfficiencyLogisticsSystem"],
  }),
  ...
  StorageTank: new StandardRecipe({
    ...
    name: "StorageTank",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { Glass: -4, IronIngot: -8, StoneBrick: -4, StorageTank: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  StrangeMatter: new StandardRecipe({
    ...
    name: "StrangeMatter",
    productionTime: new Time(8, TimeUnit.SECONDS),
    components: { Deuterium: -10, IronIngot: -2, ParticleContainer: -2, StrangeMatter: 1 },
    buildings: ["MiniatureParticleCollider"],
  ...
  StructureMatrix: new StandardRecipe({
    ...
    productionTime: new Time(8, TimeUnit.SECONDS),
    components: { Diamond: -1, TitaniumCrystal: -1, StructureMatrix: 1 },
    buildings: ["MatrixLab"],
  ...
  SuperMagneticRing: new StandardRecipe({
    ...
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { ElectromagneticTurbine: -2, EnergeticGraphite: -1, Magnet: -3, SuperMagneticRing: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  TeslaTower: new StandardRecipe({
    ...
    name: "TeslaTower",
    productionTime: new Time(1, TimeUnit.SECONDS),
    components: { IronIngot: -2, MagneticCoil: -1, TeslaTower: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["Electromagnetism"],
  }),
  ...
  ThermalPowerStation: new StandardRecipe({
    ...
    productionTime: new Time(5, TimeUnit.SECONDS),
    components: { Gear: -4, IronIngot: -10, MagneticCoil: -4, StoneBrick: -4, ThermalPowerStation: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  Thruster: new StandardRecipe({
    ...
    name: "Thruster",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { CopperIngot: -3, Steel: -2, Thruster: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  TitaniumAlloy: new StandardRecipe({
    ...
    name: "TitaniumAlloy",
    productionTime: new Time(12, TimeUnit.SECONDS),
    components: { Steel: -4, SulfuricAcid: -8, TitaniumIngot: -4, TitaniumAlloy: 4 },
    buildings: ["Smelter"],
  ...
  TitaniumCrystal: new StandardRecipe({
    ...
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { OrganicCrystal: -1, TitaniumIngot: -3, TitaniumCrystal: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  TitaniumGlass: new StandardRecipe({
    ...
    name: "TitaniumGlass",
    productionTime: new Time(5, TimeUnit.SECONDS),
    components: { Glass: -2, TitaniumIngot: -2, Water: -2, TitaniumGlass: 2 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
  ...
  TitaniumIngot: new StandardRecipe({
    ...
    name: "TitaniumIngot",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { TitaniumOre: -2, TitaniumIngot: 1 },
    buildings: ["Smelter"],
  ...
  TitaniumOre: new StandardRecipe({
    ...
    name: "TitaniumOre",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { TitaniumOreVein: -1, TitaniumOre: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  UnipolarMagnet: new StandardRecipe({
    ...
    name: "UnipolarMagnet",
    productionTime: new Time(2, TimeUnit.SECONDS),
    components: { UnipolarMagnetVein: -1, UnipolarMagnet: 1 },
    buildings: ["MiningMachine"],
    prerequisites: [],
  }),
  ...
  WaterPump: new StandardRecipe({
    ...
    name: "WaterPump",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { CircuitBoard: -2, ElectricMotor: -4, IronIngot: -8, StoneBrick: -4, WaterPump: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["FluidStorageEncapsulation"],
  }),
  ...
  WindTurbine: new StandardRecipe({
    ...
    name: "WindTurbine",
    productionTime: new Time(4, TimeUnit.SECONDS),
    components: { Gear: -1, IronIngot: -6, MagneticCoil: -3, WindTurbine: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: [],
  }),
  ...
  WirelessPowerTower: new StandardRecipe({
    ...
    productionTime: new Time(3, TimeUnit.SECONDS),
    components: { PlasmaExciter: -3, TeslaTower: -1, WirelessPowerTower: 1 },
    buildings: ["AssemblingMachineMkI", "AssemblingMachineMkII", "AssemblingMachineMkIII"],
    prerequisites: ["HighEfficiencyPlasmaControl"],
  }),
